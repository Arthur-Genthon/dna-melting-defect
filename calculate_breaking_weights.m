...
%     matDeltaG_ACGT_aTaS =  1.*ones(4,4);
%     matDeltaG_ACGT_aTaS = mean(matDeltaG_ACGT_aTaS(:)).*ones(4,4);
...
%     deltaG_bp_hbW_aTaS = deltaG_base_W_aTaS - mean2(matDeltaG_ACGT_aTaS([1, 4], [1, 4])); % AA, AT, TA, TT
%      deltaG_bp_hbW_aTaS = deltaG_base_W_aTaS - mean(matDeltaG_ACGT_aTaS(:)); % AA, AT, TA, TT
%  
   deltaG_bp_hbS_aTaS = deltaG_base_S_aTaS - mean2(matDeltaG_ACGT_aTaS([2, 3], [2, 3])); % CC, CG, GC, GG
%    deltaG_bp_hbS_aTaS = deltaG_base_S_aTaS - mean2(matDeltaG_ACGT_aTaS(:)); % CC, CG, GC, GG
